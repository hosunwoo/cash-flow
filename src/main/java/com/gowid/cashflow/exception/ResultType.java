...
/**
 * 결과값 enum https://docs.google.com/spreadsheets/d/1tluQlIS4U8VQX2cx2SNVSUjNvtsgJuhp8RHnjZ18qpM/edit#gid=0
 */
@Getter
@AllArgsConstructor
public enum ResultType {
    ...
    INTERNAL_GCS_ERROR("5100", "internal gcs error"),

    CLIENT_REQUEST_ERROR("5900", "client request error"),
